function Model_Learning_NET_2(p1,p2)
...
Ntrials0=2000;
%%Step 1: There are 4 embedded patterns in afferents for 2000 learning cycles.


Ntrials1 =5000; 
%%Step 2: There are 4 embedded patterns in afferents for 10000 learning
%%cycles. There is pre-synaptic competition. Embedded patterns are in fixed
%%positions.


Ntrials4 =5000; 
%%Step 3: There are 4 embedded patterns in afferents for 10000 learning
%%cycles. There is pre-synaptic competition. Embedded patterns are in
%%random positions.


N_psn_vec=[4 5 6 7 10];
...
intimeP_vec=(1./delt)*[200 400 600 800];
...
eval(['save Fig9b_data/N_Wa_',num2str(p1),'_',num2str(N_psn),  '.mat W_veca']);
eval(['save Fig9b_data/N_Wb_',num2str(p1),'_',num2str(N_psn),  '.mat W_vecb']);
eval(['save Fig9b_data/N_EP_',num2str(p1),'_',num2str(N_psn),  '.mat PAT']);
eval(['save Fig9b_data/N_Filterd_Spikes_',num2str(p1),'_',num2str(N_psn),  '.mat Filterd_Spikes']);
eval(['save Fig9b_data/N_del_a_E_',num2str(p1),'_',num2str(N_psn),  '.mat del_a_E']);
eval(['save Fig9b_data/N_del_b_I_',num2str(p1),'_',num2str(N_psn),  '.mat del_b_I']);
eval(['save Fig9b_data/N_del_b_E_',num2str(p1),'_',num2str(N_psn),  '.mat del_b_E']);
...
eval(['save Fig9b_data/Wa_',num2str(p1),'_',num2str(N_psn),  '.mat W_veca']);
eval(['save Fig9b_data/Wb_',num2str(p1),'_',num2str(N_psn),  '.mat W_vecb']);
eval(['save Fig9b_data/EP_',num2str(p1),'_',num2str(N_psn),  '.mat PAT']);
eval(['save Fig9b_data/Omega_',num2str(p1),'_',num2str(N_psn),  '.mat Omega_R']);
eval(['save Fig9b_data/ns15_',num2str(p1),'_',num2str(N_psn),  '.mat ns_15']);
eval(['save Fig9b_data/Spikess_',num2str(p1),'_',num2str(N_psn),  '.mat Spikess_p']);


%step3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%with competition % random position

eval(['load Fig9b_data/N_Wa_',num2str(p1),'_',num2str(N_psn),  '.mat W_veca']);
eval(['load Fig9b_data/N_Wb_',num2str(p1),'_',num2str(N_psn),  '.mat W_vecb']);
eval(['load Fig9b_data/N_EP_',num2str(p1),'_',num2str(N_psn),  '.mat PAT']);
eval(['load Fig9b_data/N_Filterd_Spikes_',num2str(p1),'_',num2str(N_psn),  '.mat Filterd_Spikes']);
eval(['load Fig9b_data/N_del_a_E_',num2str(p1),'_',num2str(N_psn),  '.mat del_a_E']);
eval(['load Fig9b_data/N_del_b_I_',num2str(p1),'_',num2str(N_psn),  '.mat del_b_I']);
eval(['load Fig9b_data/N_del_b_E_',num2str(p1),'_',num2str(N_psn),  '.mat del_b_E']);

Omega_R=zeros(1,Ntrials4);
num_emb_vec=zeros(1,Ntrials4);
intimeP_vec=(1./delt)*(85:90:895);
for itrial=1:Ntrials4
    
        which_pattern=randperm(em);
        num_emb=(randi(em+1))-1;
        num_emb_vec(1,itrial)=num_emb;
        ...
        if num_emb>0
            ti=randperm(numel(intimeP_vec));
            for i=1:num_emb
                 PATP(:, intimeP_vec(1,ti(i))+1: intimeP_vec(1,ti(i)) + TP) = PAT(:,:,which_pattern(i));  
            end
        end
        for i = 1: NI
        ...
        if num_emb>0        
            V_vec2=V_vec>=1;
            V_vec1=zeros(num_emb,N_psn);
                for io=1:num_emb
                    V_vec1(io,:)=sum(V_vec2(intimeP_vec(1,ti(io))+1:intimeP_vec(1,ti(io))+TP+150,:),1);
                end
            Omega_R(1,itrial)=rank(double(V_vec1>0))/(1e-16+num_emb);
        end
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
...
eval(['save Fig9b_data/RWa_',num2str(p1),'_',num2str(N_psn),  '.mat W_veca']);
eval(['save Fig9b_data/RWb_',num2str(p1),'_',num2str(N_psn),  '.mat W_vecb']);
eval(['save Fig9b_data/REP_',num2str(p1),'_',num2str(N_psn),  '.mat PAT']);
eval(['save Fig9b_data/ROmega_',num2str(p1),'_',num2str(N_psn),  '.mat Omega_R']);
eval(['save Fig9b_data/Rnum_emb_vec_',num2str(p1),'_',num2str(N_psn),  '.mat num_emb_vec']);
