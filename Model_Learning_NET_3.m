...
Ntrials1 =20000; 
%%Step 2: There are 10 embedded patterns in afferents for 20000 learning
...
eval(['save ',num2str(N_psn,'%.i') '/Wa_',num2str(p1),'_',num2str(N_psn),  '.mat W_veca']);
eval(['save ',num2str(N_psn,'%.i') '/Wb_',num2str(p1),'_',num2str(N_psn),  '.mat W_vecb']);
eval(['save ',num2str(N_psn,'%.i') '/EP_',num2str(p1),'_',num2str(N_psn),  '.mat PAT']);
eval(['save ',num2str(N_psn,'%.i') '/Omega_',num2str(p1),'_',num2str(N_psn),  '.mat Omega_R']);
eval(['save ',num2str(N_psn,'%.i') '/Spikess_',num2str(p1),'_',num2str(N_psn),  '.mat Spikess_p']);
