...
Ntrials=5e3; %number of learning cycles
...
for p1=1:N_mu
    ...
    try
        eval(['load Noise_Robustness/Learn_Jit_2/Data_ns_0/ER_',num2str(p1),'_',num2str(p2),  '.mat ns_0']);
        eval(['load Noise_Robustness/Learn_Jit_2/Data_ns_15/ER_',num2str(p1),'_',num2str(p2),  '.mat ns_15']);
        eval(['load Noise_Robustness/Learn_Jit_2/Spikes/spike_',num2str(p1),'_',num2str(p2),  '.mat Spikess']);
    catch       
    end
...
for i=1:Ntrials
    fg=Results3(:,i);
    R(1,i)=sum(Results0(:,i))/(1e-16+numel(fg));      
end
...
for p1=1:N_mu
    ...
    try
        eval(['load Noise_Robustness/Learn_Jit_2/Data_ns_0/ER_0_',num2str(p1),'_',num2str(p2),  '.mat ns_0_1']);
        eval(['load Noise_Robustness/Learn_Jit_2/Data_ns_15/ER_1_',num2str(p1),'_',num2str(p2),  '.mat ns_15_1']);
        eval(['load Noise_Robustness/Learn_Jit_2/Spikes/spike_1_',num2str(p1),'_',num2str(p2),  '.mat Spikess_1']);    catch       
    end
